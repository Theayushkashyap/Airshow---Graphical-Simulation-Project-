...
void front()
{
        ...
        output(365,130," KALPATARU INSTITUTE OF TECHNOLOGY",fonts[3]);
        ...
        glColor3f(0.3,0.5,0.8);
        output(225,450,"Aditya S Gowda",fonts[3]);
        output(670,450,"Ayush Kashyap",fonts[3]);
        output(180,300,"",fonts[3]);
        output(220,400,"(1KI21CS003)",fonts[0]);
        output(680,400,"(1KI21CS011)",fonts[0]);
...
void help()
{
        ...
        glColor3f(0.5,0.2,0.6);
        output(600,60,"[ Dept. of CSE, KIT ]",fonts[0]);
}
void intro()
{
        glColor3f(0.8,0.1,0.2);
